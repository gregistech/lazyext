...
import "DeviceInterface.dart" as deviceinterface_;
...
/// from: com.gergovari.mupdf.ExtendedDevice
class ExtendedDevice extends device_.Device {
  @override
  late final jni.JObjType<ExtendedDevice> $type = type;

  ExtendedDevice.fromRef(
    jni.JObjectPtr ref,
  ) : super.fromRef(ref);

  static final _class =
      jni.Jni.findJClass(r"com/gergovari/mupdf/ExtendedDevice");

  /// The type which includes information such as the signature of this class.
  static const type = $ExtendedDeviceType();
  static final _id_ctor2 = jni.Jni.accessors.getMethodIDOf(
      _class.reference, r"<init>", r"(Lcom/gergovari/mupdf/DeviceInterface;)V");

  /// from: public void <init>(com.gergovari.mupdf.DeviceInterface deviceInterface)
  /// The returned object must be deleted after use, by calling the `delete` method.
  factory ExtendedDevice.ctor2(
    deviceinterface_.DeviceInterface deviceInterface,
  ) {
    return ExtendedDevice.fromRef(jni.Jni.accessors.newObjectWithArgs(
        _class.reference, _id_ctor2, [deviceInterface.reference]).object);
  }
...
class $ExtendedDeviceType extends jni.JObjType<ExtendedDevice> {
  const $ExtendedDeviceType();

  @override
  String get signature => r"Lcom/gergovari/mupdf/ExtendedDevice;";

  @override
  ExtendedDevice fromRef(jni.JObjectPtr ref) => ExtendedDevice.fromRef(ref);
  ...
  @override
  int get hashCode => ($ExtendedDeviceType).hashCode;

  @override
  bool operator ==(Object other) {
    return other.runtimeType == ($ExtendedDeviceType) &&
        other is $ExtendedDeviceType;
  }
}
